...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def send_group_req(self, datapath):
        ...
        buckets = [parser.OFPBucket(weight1,watch_port1, watch_group, actions=actions1),
                   parser.OFPBucket(weight2, watch_port2, watch_group, actions=actions2)]
        
        req = parser.OFPGroupMod(datapath, ofproto.OFPGC_ADD,
                                 ofproto.OFPGT_SELECT, 20, buckets)
